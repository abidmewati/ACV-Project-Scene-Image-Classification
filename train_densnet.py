...
def train_one_epoch(model, loader, criterion, optimizer, device):
    ...
    for images, labels in loader:
        ...
        # Handle models like InceptionV3 that return auxiliary outputs
...
if __name__ == "__main__":
    ...
    # Replace the classification head for DenseNet (1024 features in, NUM_CLASSES out)
    densenet121.classifier = nn.Linear(in_features=1024, out_features=NUM_CLASSES)
    ...
    # 4. Plot Metrics
    plot_results(results, "DenseNet121")